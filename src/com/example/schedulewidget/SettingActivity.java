...
public class SettingActivity extends Activity
{
    ...
    private void SavePreference()
    {
        ...
        sharedPreferencesEditor.putString(GlobalVariables.PREFERENCE_LOGIN_KEY, editTextLogin.getText().toString());
        sharedPreferencesEditor.putString(GlobalVariables.PREFERENCE_PASS_KEY, editTextPass.getText().toString());
        sharedPreferencesEditor.putString(GlobalVariables.PREFERENCE_RELEVANCE_TIME_KEY, editTextScheduleRelevanceTime.getText().toString());
        sharedPreferencesEditor.putBoolean(GlobalVariables.PREFERENCE_SHOW_TOASTS_KEY, checkBoxToastMsgs.isChecked());
    ...
    {
        SharedPreferences sharedPreferences = getSharedPreferences(GlobalVariables.SHARED_PREFERENCE_NAME, MODE_PRIVATE);
        PreferenceLogin = sharedPreferences.getString(GlobalVariables.PREFERENCE_LOGIN_KEY, PREFERENCE_LOGIN_DEFVAL);
        PreferencePass = sharedPreferences.getString(GlobalVariables.PREFERENCE_PASS_KEY, PREFERENCE_PASS_DEFVAL);
        PreferenceRelevanceTime = sharedPreferences.getString(GlobalVariables.PREFERENCE_RELEVANCE_TIME_KEY, PREFERENCE_RELEVANCE_TIME_DEFVAL);
        PreferenceShowToasts = sharedPreferences.getBoolean(GlobalVariables.PREFERENCE_SHOW_TOASTS_KEY, GlobalVariables.PREFERENCE_SHOW_TOASTS_DEFVAL);
